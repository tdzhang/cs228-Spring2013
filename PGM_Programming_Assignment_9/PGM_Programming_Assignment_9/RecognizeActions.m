...
for a=1:length(datasetTrain)
  [Ps{a} loglikelihood{a} ClassProb{a} PairProb{a}] = EM_HMM(datasetTrain(a).actionData, datasetTrain(a).poseData, G, datasetTrain(a).InitialClassProb, datasetTrain(a).InitialPairProb, maxIter);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
