...
genotypeFactor.card = [numAlleles+numAlleles*( numAlleles-1)/2];
...
for i=1: numAlleles 
    for j=i: numAlleles 
        if (i==j)
            genotypeFactor.val (allelesToGenotypes(i, j)) = A(i,j);
        else 
            genotypeFactor.val (allelesToGenotypes(i, j)) = 2*A(i,j);
        end
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  