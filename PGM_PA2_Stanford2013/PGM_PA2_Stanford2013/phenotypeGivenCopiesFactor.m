...
for i=1:numAlleles
    for j=1:numAlleles
        phenotypeFactor.val(AssignmentToIndex([1, i, j], [2, numAlleles, numAlleles])) = alphaList(allelesToGenotypes(i, j));
        phenotypeFactor.val(AssignmentToIndex([2, i, j], [2, numAlleles, numAlleles])) = 1-alphaList(allelesToGenotypes(i, j));
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%